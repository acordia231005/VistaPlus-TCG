...
(3, 'SERIE', 'Dragon Ball Z', 'Guerreros luchan por salvar la Tierra.', '1989-04-26', '', 1, 1),
(4, 'SERIE', 'Dr. Slump', 'Comedia absurda con robots y ciencia.', '1981-04-08', '', 3, 1),

(5, 'LIBRO', 'Manga Arte', 'Guía sobre cómo dibujar manga.', '2000-01-01', '', 17, 1),
(6, 'LIBRO', 'Dragon Ball Vol.1', 'Inicio de la aventura de Goku.', '1984-12-03', '', 23, 1);
